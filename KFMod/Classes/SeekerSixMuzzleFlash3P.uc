//=============================================================================
// SeekerSixMuzzleFlash3P
//=============================================================================
// Third person muzzle flash emitter class for the SeekerSix mini rocket launcher
//=============================================================================
// Killing Floor Source
// Copyright (C) 2013 Tripwire Interactive LLC
// - John "Ramm-Jaeger" Gibson
//=============================================================================
class SeekerSixMuzzleFlash3P extends ROMuzzleFlash3rd;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'KFMod.SeekerSixMuzzleFlash3P.SpriteEmitter1'
     ...
     End Object
     Emitters(1)=SpriteEmitter'KFMod.SeekerSixMuzzleFlash3P.SpriteEmitter3'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         StartSizeRange=(X=(Min=7.000000,Max=13.000000))
         DrawStyle=PTDS_AlphaBlend
         Texture=Texture'Effects_Tex.Smoke.LightSmoke_8Frame'
         TextureUSubdivisions=4
         TextureVSubdivisions=4
     ...
     End Object
     Emitters(2)=SpriteEmitter'KFMod.SeekerSixMuzzleFlash3P.SpriteEmitter4'
     ...
     End Object
     Emitters(3)=SpriteEmitter'KFMod.SeekerSixMuzzleFlash3P.SpriteEmitter5'
