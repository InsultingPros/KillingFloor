...
defaultproperties
{
     ...
     MediItemForSale(6)=Class'KFMod.NeonKrissMPickup'
     ...
     SuppItemForSale(4)=Class'KFMod.NeonKSGPickup'
     SuppItemForSale(5)=Class'KFMod.NailGunPickup'
     SuppItemForSale(6)=Class'KFMod.SPShotgunPickup'
     SuppItemForSale(7)=Class'KFMod.BenelliPickup'
     SuppItemForSale(8)=Class'KFMod.GoldenBenelliPickup'
     SuppItemForSale(9)=Class'KFMod.AA12Pickup'
     SuppItemForSale(10)=Class'KFMod.GoldenAA12Pickup'
     ...
     CommItemForSale(6)=Class'KFMod.NeonAK47Pickup'
     CommItemForSale(7)=Class'KFMod.M4Pickup'
     CommItemForSale(8)=Class'KFMod.CamoM4Pickup'
     CommItemForSale(9)=Class'KFMod.MKb42Pickup'
     CommItemForSale(10)=Class'KFMod.SCARMK17Pickup'
     CommItemForSale(11)=Class'KFMod.NeonSCARMK17Pickup'
     CommItemForSale(12)=Class'KFMod.FNFAL_ACOG_Pickup'
