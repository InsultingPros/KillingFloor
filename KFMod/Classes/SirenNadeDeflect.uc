...
// Siren Nade Deflect
//=============================================================================
// Effect when the siren's scream destroys a projectile
//=============================================================================
// Killing Floor Source
// Copyright (C) 2009 Tripwire Interactive LLC
// Created by - David Hensley
//=============================================================================
class SirenNadeDeflect extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'KFMod.SirenNadeDeflect.SpriteEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'KFMod.SirenNadeDeflect.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter44
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(G=103,R=206,A=255))
         ...
         ColorScale(6)=(RelativeTime=1.000000,Color=(R=255,A=255))
         ...
         StartVelocityRange=(X=(Min=-200.000000,Max=200.000000),Y=(Min=-200.000000,Max=200.000000),Z=(Min=-200.000000,Max=200.000000))
     End Object
     Emitters(2)=SpriteEmitter'KFMod.SirenNadeDeflect.SpriteEmitter44'
