...
//=============================================================================
// Fuse trail emitter class for the seal squeal harpoon bomb launcher
//=============================================================================
// Killing Floor Source
// Copyright (C) 2013 Tripwire Interactive LLC
// - John "Ramm-Jaeger" Gibson
//=============================================================================
class SealSquealFuseEmitter extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(1)=SpriteEmitter'KFMod.SealSquealFuseEmitter.SpriteEmitter24'
     ...
     End Object
     Emitters(2)=SpriteEmitter'KFMod.SealSquealFuseEmitter.SpriteEmitter25'
