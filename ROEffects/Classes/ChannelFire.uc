class ChannelFire extends FoundryFX;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter145
         ...
         MaxParticles=450
         DetailMode=DM_High
         StartLocationRange=(X=(Min=-700.000000,Max=700.000000),Y=(Min=-30.000000,Max=30.000000))
         ...
         StartSizeRange=(X=(Min=5.000000,Max=40.000000),Y=(Min=0.000000,Max=0.000000),Z=(Min=0.000000,Max=0.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'ROEffects.ChannelFire.SpriteEmitter145'
