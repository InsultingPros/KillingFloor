...
//=============================================================================
class TankCannonFireEffect_simple extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'ROEffects.TankCannonFireEffect_simple.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         StartVelocityRange=(X=(Min=250.000000,Max=1000.000000),Y=(Min=-50.000000,Max=50.000000),Z=(Min=-50.000000,Max=50.000000))
     ...
     End Object
     Emitters(1)=SpriteEmitter'ROEffects.TankCannonFireEffect_simple.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         Texture=Texture'Effects_Tex.explosions.DSmoke_2'
         LifetimeRange=(Min=3.000000,Max=3.000000)
         StartVelocityRange=(X=(Min=500.000000,Max=1000.000000),Y=(Min=-100.000000,Max=100.000000),Z=(Min=-100.000000,Max=100.000000))
         VelocityLossRange=(X=(Min=0.500000,Max=1.000000),Y=(Min=0.500000,Max=1.000000),Z=(Min=0.500000,Max=1.000000))
         VelocityScale(0)=(RelativeVelocity=(X=1.000000,Y=1.000000,Z=1.000000))
         VelocityScale(1)=(RelativeTime=0.500000,RelativeVelocity=(X=0.200000,Y=0.200000,Z=0.200000))
         VelocityScale(2)=(RelativeTime=1.000000)
     End Object
     Emitters(2)=SpriteEmitter'ROEffects.TankCannonFireEffect_simple.SpriteEmitter2'
     ...
     End Object
     Emitters(3)=SpriteEmitter'ROEffects.TankCannonFireEffect_simple.SpriteEmitter3'
     ...
     End Object
     Emitters(4)=SpriteEmitter'ROEffects.TankCannonFireEffect_simple.SpriteEmitter4'
     ...
     End Object
     Emitters(5)=SpriteEmitter'ROEffects.TankCannonFireEffect_simple.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         StartVelocityRange=(X=(Min=20.000000,Max=25.000000))
     End Object
     Emitters(6)=SpriteEmitter'ROEffects.TankCannonFireEffect_simple.SpriteEmitter6'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter7
         ...
         StartVelocityRange=(X=(Min=20.000000,Max=25.000000))
     End Object
     Emitters(7)=SpriteEmitter'ROEffects.TankCannonFireEffect_simple.SpriteEmitter7'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter8
         ...
         AutomaticInitialSpawning=False
         Acceleration=(X=100.000000,Y=100.000000)
         ColorScale(0)=(Color=(B=63,G=63,R=63,A=255))
         ...
         StartVelocityRange=(X=(Min=-450.000000,Max=450.000000),Y=(Min=300.000000,Max=1500.000000),Z=(Min=-450.000000,Max=450.000000))
         ...
         VelocityScale(2)=(RelativeTime=1.000000)
     End Object
     Emitters(8)=SpriteEmitter'ROEffects.TankCannonFireEffect_simple.SpriteEmitter8'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter9
         ...
         Texture=Texture'Effects_Tex.explosions.DSmoke_2'
         LifetimeRange=(Min=2.500000,Max=2.500000)
         StartVelocityRange=(X=(Min=-450.000000,Max=450.000000),Y=(Min=-1500.000000,Max=-300.000000),Z=(Min=-450.000000,Max=450.000000))
         VelocityLossRange=(X=(Min=1.000000,Max=3.000000),Y=(Min=1.000000,Max=3.000000),Z=(Min=1.000000,Max=3.000000))
         VelocityScale(0)=(RelativeVelocity=(X=1.000000,Y=1.000000,Z=1.000000))
         VelocityScale(1)=(RelativeTime=0.125000,RelativeVelocity=(X=0.200000,Y=0.200000,Z=0.200000))
         VelocityScale(2)=(RelativeTime=1.000000)
     End Object
     Emitters(9)=SpriteEmitter'ROEffects.TankCannonFireEffect_simple.SpriteEmitter9'
