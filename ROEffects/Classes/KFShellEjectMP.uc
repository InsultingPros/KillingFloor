class KFShellEjectMP extends KFShellEject;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter2733
         StaticMesh=StaticMesh'kf_generic_sm.Bullet_Shells.9mm_Shell'
         ...
         StartVelocityRange=(Y=(Min=-150.000000,Max=-50.000000),Z=(Min=150.000000,Max=200.000000))
     End Object
     Emitters(0)=MeshEmitter'ROEffects.KFShellEjectMP.MeshEmitter2733'

     Begin Object Class=SpriteEmitter Name=SpriteEmitter2735
         ...
         StartVelocityRange=(X=(Min=-100.000000,Max=100.000000),Y=(Min=-150.000000),Z=(Min=150.000000,Max=200.000000))
     End Object
     Emitters(1)=SpriteEmitter'ROEffects.KFShellEjectMP.SpriteEmitter2735'
