//=============================================================================
// ROPlayerInput
// Object within ROPlayer that manages player input.
// only spawned on client
// Author. Ramm-Jaeger
// Note, left a bunch of unreal stuff in here in case anyone wants to modify it
//=============================================================================

class ROPlayerInput extends PlayerInput within ROPlayer
	config(User);
...
event PlayerInput( float DeltaTime )
{
    ...
    // Modify mouse sensitivity based on prone scaler - Not needed any more - Ramm
	//aMouseX = aMouseX * Outer.GetProneModifier();
	//aMouseY = aMouseY * Outer.GetProneModifier();
...
static function float GetMouseSensitivity()
{
	return default.MouseSensitivity;
}
...
function float GetDefaultSensitivity()
{
    return default.MouseSensitivity;
}
